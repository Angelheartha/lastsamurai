...
def detail(request, question_id):
    ...
    return render(request, 'polls/polls/detail.html', {'question': question})
...
def vote(request, question_id):
    ...
    try:selected_choice = question.choice_set.get(pk=request.POST['choice'])
       ...
       return render(request,'polls/polls/detail.html', {
                          'question': question,
...
def results(request,question_id):
    ...
    'polls/polls/results.html',{'question':question})
